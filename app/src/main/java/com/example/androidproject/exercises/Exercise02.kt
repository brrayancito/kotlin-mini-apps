package com.example.androidproject.exercises
...
A senior ticket price of $20 for people 61 years old and older. Assume that the maximum age
    of a moviegoer is 100 years old.
...
//    var ticketPrice = 0
//    if (age < 1 || age > 100) ticketPrice = -1
//
//    if (age <= 12) ticketPrice = 15
//    if (age in 61..100) ticketPrice = 20
//
//    if (age in 13..60) {
//        ticketPrice = if (isMonday) 25 else 30
//    }
//    return ticketPrice
}
